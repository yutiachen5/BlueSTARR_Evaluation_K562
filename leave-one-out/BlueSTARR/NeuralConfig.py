...
class NeuralConfig:
    def __init__(self,filename):
        ...
        # leave-one-out
        self.TrainData = [x for x in config.lookupListOrDie("TrainData")]
        self.TestData = config.lookupListOrDie("TestData")
        self.ValidationData = config.lookupListOrDie("ValidationData")
